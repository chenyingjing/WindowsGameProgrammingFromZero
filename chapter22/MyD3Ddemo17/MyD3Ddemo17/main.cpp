...
HRESULT Objects_Init(HWND hwnd)
{
	...
	if (FAILED(D3DXLoadMeshFromX(L"bee.X", D3DXMESH_MANAGED, g_pd3dDevice, &pAdjBuffer, &pMtrlBuffer, NULL, &g_dwNumMtrls, &g_pMesh)))
		return E_FAIL;
...
*/
	...
	//g_pCamera->SetCameraPosition(&D3DXVECTOR3(0.0f, 40000.0f, 0.0f));
	...
	g_pTerrain->InitTerrain(320, 320, 200.0f, 10.0f);
...
void Direct3D_Render(HWND hwnd)
{
	...
	D3DXMatrixScaling(&mScal, 20.0f, 20.f, 20.f);
	...
	{
		D3DXMatrixTranslation(&TransMatrix, -10000, 0.0f, -15000.0f + (i * 20000.0f));
