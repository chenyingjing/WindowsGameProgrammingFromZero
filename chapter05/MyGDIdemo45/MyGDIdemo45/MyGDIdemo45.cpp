...
VOID Game_Paint( HWND hwnd )
{
	...
	TransparentBlt(g_hdc, 450, WINDOW_HEIGHT - 584, 400, 584, g_mdc, 0, 0, 400, 584, RGB(0, 0, 0));//透明色为RGB(0,0,0)

	//用透明遮罩法绘制出第一个人物
	SelectObject(g_mdc, g_hCharacter1);
	BitBlt(g_hdc, -50, WINDOW_HEIGHT - 650, 535, 650, g_mdc, 535, 0, SRCAND);//透明遮罩法第一步，即将屏蔽图与背景图做"AND"运算 
	BitBlt(g_hdc, -50, WINDOW_HEIGHT - 650, 535, 650, g_mdc, 0, 0, SRCPAINT);//透明遮罩法第二步，即将前景图与背景图做"OR"运算
