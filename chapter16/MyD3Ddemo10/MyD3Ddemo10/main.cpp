...
HRESULT Objects_Init(HWND hwnd)
{
	...
	pVertices[1] = CUSTOMVERTEX(10.0f, 10.0f, -10.f, 1.0f, 0.0f);
	pVertices[2] = CUSTOMVERTEX(10.0f, -10.0f, -10.f, 1.0f, 1.0f);
	pVertices[3] = CUSTOMVERTEX(-10.0f, -10.0f, -10.f, 0.0f, 1.0f);

	pVertices[4] = CUSTOMVERTEX(10.0f, 10.0f, 10.f, 0.0f, 0.0f);
	pVertices[5] = CUSTOMVERTEX(-10.0f, 10.0f, 10.f, 1.0f, 0.0f);
	pVertices[6] = CUSTOMVERTEX(-10.0f, -10.0f, 10.f, 1.0f, 1.0f);
	pVertices[7] = CUSTOMVERTEX(10.0f, -10.0f, 10.f, 0.0f, 1.0f);

	pVertices[8] = CUSTOMVERTEX(-10.0f, 10.0f, 10.f, 0.0f, 0.0f);
	pVertices[9] = CUSTOMVERTEX(10.0f, 10.0f, 10.f, 1.0f, 0.0f);
	pVertices[10] = CUSTOMVERTEX(10.0f, 10.0f, -10.f, 1.0f, 1.0f);
	pVertices[11] = CUSTOMVERTEX(-10.0f, 10.0f, -10.f, 0.0f, 1.0f);

	pVertices[12] = CUSTOMVERTEX(-10.0f, -10.0f, -10.f, 0.0f, 0.0f);
	pVertices[13] = CUSTOMVERTEX(10.0f, -10.0f, -10.f, 1.0f, 0.0f);
	pVertices[14] = CUSTOMVERTEX(10.0f, -10.0f, 10.f, 1.0f, 1.0f);
	pVertices[15] = CUSTOMVERTEX(-10.0f, -10.0f, 10.f, 0.0f, 1.0f);
...
void Direct3D_Render(HWND hwnd)
{
	...
	formatRect.top += 25;
	g_pTextHelper->DrawText(NULL, _T("键盘上1,2,数字键：在2种模式之间切换"), -1, &formatRect, DT_SINGLELINE | DT_NOCLIP | DT_LEFT, D3DCOLOR_RGBA(255, 200, 0, 255));
