...
void Matrix_Set()
{
	...
	D3DXVECTOR3 vEye(0.0f, 0.0f, -1200.0f);  //摄像机的位置
	...
	D3DXMatrixPerspectiveFovLH(&matProj, D3DX_PI / 4.0f, (float)((double)WINDOW_WIDTH / WINDOW_HEIGHT), 1.0f, 2000.0f); //计算投影变换矩阵
