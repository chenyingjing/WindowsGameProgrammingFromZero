...
HRESULT Objects_Init(HWND hwnd)
{
	...
	if (FAILED(D3DXLoadMeshFromX(L"angle.X", D3DXMESH_MANAGED,
		g_pd3dDevice, &pAdjBuffer, &pMtrlBuffer, NULL, &g_dwNumMtrls, &g_pMesh)))
	{
		return E_FAIL;
	}
	...
	g_pSkyBox->LoadSkyTextureFromFile(L"GameMedia\\TropicalSunnyDayFront2048.png", L"GameMedia\\TropicalSunnyDayBack2048.png",
		L"GameMedia\\TropicalSunnyDayRight2048.png", L"GameMedia\\TropicalSunnyDayLeft2048.png", L"GameMedia\\TropicalSunnyDayUp2048.png");
